  ...
  public PaymentTransactionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfPaymentTransactionEntity = new EntityInsertionAdapter<PaymentTransactionEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `payment_transactions` (`id`,`representativeId`,`invoiceId`,`paymentDate`,`amountPaid`,`paymentMethod`,`notes`) VALUES (?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfPaymentTransactionEntity = new EntityDeletionOrUpdateAdapter<PaymentTransactionEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `payment_transactions` SET `id` = ?,`representativeId` = ?,`invoiceId` = ?,`paymentDate` = ?,`amountPaid` = ?,`paymentMethod` = ?,`notes` = ? WHERE `id` = ?";
      }
      ...
      public List<PaymentTransactionEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new PaymentTransactionEntity(_tmpId,_tmpRepresentativeId,_tmpInvoiceId,_tmpPaymentDate,_tmpAmountPaid,_tmpPaymentMethod,_tmpNotes);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public PaymentTransactionEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new PaymentTransactionEntity(_tmpId,_tmpRepresentativeId,_tmpInvoiceId,_tmpPaymentDate,_tmpAmountPaid,_tmpPaymentMethod,_tmpNotes);
          } else {
            _result = null;
          }
          return _result;

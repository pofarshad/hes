...
public final class VpnResellerDatabase_Impl extends VpnResellerDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `representatives` (`id` TEXT NOT NULL, `fullName` TEXT NOT NULL, `adminUsernameMarzban` TEXT NOT NULL, `telegramLink` TEXT, `pricePerGbLimited` REAL NOT NULL, `monthlyUnlimitedPrice` REAL NOT NULL, `discountType` TEXT NOT NULL, `discountValue` REAL NOT NULL, `parentRepresentativeId` TEXT, `defaultSubscriptionType` TEXT NOT NULL, `defaultDurationMonths` INTEGER NOT NULL, `isActive` INTEGER NOT NULL, `notes` TEXT, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS `invoices` (`id` TEXT NOT NULL, `representativeId` TEXT NOT NULL, `generationDate` INTEGER NOT NULL, `totalAmount` REAL NOT NULL, `status` TEXT NOT NULL, `isSentToTelegram` INTEGER NOT NULL, `pdfPath` TEXT, `imagePath` TEXT, `importedSheetData` TEXT, PRIMARY KEY(`id`))");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `payment_transactions` (`id` TEXT NOT NULL, `representativeId` TEXT NOT NULL, `invoiceId` TEXT, `paymentDate` INTEGER NOT NULL, `amountPaid` REAL NOT NULL, `paymentMethod` TEXT NOT NULL, `notes` TEXT, `type` TEXT NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '3bc1a78333d010b0e8a5098c27e08b45')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsRepresentatives = new HashMap<String, TableInfo.Column>(13);
        ...
        _columnsRepresentatives.put("notes", new TableInfo.Column("notes", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final HashMap<String, TableInfo.Column> _columnsInvoices = new HashMap<String, TableInfo.Column>(9);
        _columnsInvoices.put("id", new TableInfo.Column("id", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsInvoices.put("representativeId", new TableInfo.Column("representativeId", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsInvoices.put("generationDate", new TableInfo.Column("generationDate", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsInvoices.put("isSentToTelegram", new TableInfo.Column("isSentToTelegram", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsInvoices.put("pdfPath", new TableInfo.Column("pdfPath", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsInvoices.put("imagePath", new TableInfo.Column("imagePath", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsInvoices.put("importedSheetData", new TableInfo.Column("importedSheetData", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoInvoices.equals(_existingInvoices)) {
          return new RoomOpenHelper.ValidationResult(false, "invoices(com.vpnreseller.core_data.local.entity.InvoiceEntity).\n"
                  + " Expected:\n" + _infoInvoices + "\n"
                  + " Found:\n" + _existingInvoices);
        }
        ...
        final HashMap<String, TableInfo.Column> _columnsPaymentTransactions = new HashMap<String, TableInfo.Column>(8);
        ...
        _columnsPaymentTransactions.put("type", new TableInfo.Column("type", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "3bc1a78333d010b0e8a5098c27e08b45", "22026303188fc597d11bae6fb976de90");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "representatives","invoices","invoice_line_items","payment_transactions");
  }

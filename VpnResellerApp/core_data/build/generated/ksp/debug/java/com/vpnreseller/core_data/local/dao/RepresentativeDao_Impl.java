  ...
  public RepresentativeDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfRepresentativeEntity = new EntityInsertionAdapter<RepresentativeEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `representatives` (`id`,`fullName`,`adminUsernameMarzban`,`telegramLink`,`pricePerGbLimited`,`monthlyUnlimitedPrice`,`discountType`,`discountValue`,`parentRepresentativeId`,`defaultSubscriptionType`,`defaultDurationMonths`,`isActive`,`notes`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfRepresentativeEntity = new EntityDeletionOrUpdateAdapter<RepresentativeEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `representatives` SET `id` = ?,`fullName` = ?,`adminUsernameMarzban` = ?,`telegramLink` = ?,`pricePerGbLimited` = ?,`monthlyUnlimitedPrice` = ?,`discountType` = ?,`discountValue` = ?,`parentRepresentativeId` = ?,`defaultSubscriptionType` = ?,`defaultDurationMonths` = ?,`isActive` = ?,`notes` = ? WHERE `id` = ?";
      }
      ...
      public List<RepresentativeEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new RepresentativeEntity(_tmpId,_tmpFullName,_tmpAdminUsernameMarzban,_tmpTelegramLink,_tmpPricePerGbLimited,_tmpMonthlyUnlimitedPrice,_tmpDiscountType,_tmpDiscountValue,_tmpParentRepresentativeId,_tmpDefaultSubscriptionType,_tmpDefaultDurationMonths,_tmpIsActive,_tmpNotes);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public RepresentativeEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new RepresentativeEntity(_tmpId,_tmpFullName,_tmpAdminUsernameMarzban,_tmpTelegramLink,_tmpPricePerGbLimited,_tmpMonthlyUnlimitedPrice,_tmpDiscountType,_tmpDiscountValue,_tmpParentRepresentativeId,_tmpDefaultSubscriptionType,_tmpDefaultDurationMonths,_tmpIsActive,_tmpNotes);
          } else {
            _result = null;
          }
          return _result;
